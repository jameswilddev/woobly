...
-------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------
[@woobly/build](@woobly/build)                           | [![0.0.0](https://img.shields.io/npm/v/@woobly/build.svg)](https://www.npmjs.com/package/@woobly/build)                           | A command-line tool to perform a production build of Woobly applications.
